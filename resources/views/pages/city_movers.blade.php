...
@section('title', $cityModel->content->meta_title ?? 'Movers in ' . $cityName . ' | Move Smooth Moving Company')
@section('meta_description', $cityModel->content->meta_description ?? 'Looking for reliable movers in ' . $cityName . '? Move Smooth provides affordable local and long-distance moving services.')
...
<script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "item": "{{ route('front.state.movers', $stateModel->slug ?: \Illuminate\Support\Str::slug($stateModel->name)) }}"
        },
        {
            "@@type": "ListItem",
            "position": 4,
            "name": "Movers in {{ $cityName }}",
            "item": "{{ url()->current() }}"
        }
    ]
}
...
<script type="application/ld+json">
{
    ...
    "mainEntity": {
        "@@type": "MovingCompany",
        "name": "Move Smooth {{ $cityName }}",
        "description": "{{ $cityModel->content->meta_description ?? 'Professional movers in ' . $cityName }}",
        "url": "{{ url()->current() }}",
        "address": { 
            "@@type": "PostalAddress", 
...
<script type="application/ld+json">
{
    ...
    "@@type": "FAQPage",
    "mainEntity": [
        @if(\Illuminate\Support\Facades\Schema::hasTable('city_faqs') && $cityModel->faqs->count() > 0)
            @foreach($cityModel->faqs as $index => $faq)
            {
                "@@type": "Question",
        ...
        @else
            { 
                "@@type": "Question", 
                "name": "How much do movers cost in {{ $cityName }}?", 
                "acceptedAnswer": { 
                    "@@type": "Answer", 
                    "text": "Local moves in {{ $cityName }} typically cost between $400 and $1,500 depending on home size. Long-distance relocations range from $2,500 to $6,000+ based on shipment weight and mileage." 
                } 
            },
            { 
                "@@type": "Question", 
                "name": "Are movers in {{ $cityName }} licensed?", 
                "acceptedAnswer": { 
                    "@@type": "Answer", 
                    "text": "Yes. All movers listed on Move Smooth hold active USDOT numbers and FMCSA registrations with verified insurance." 
                } 
            },
            { 
                "@@type": "Question", 
                "name": "How do I get a moving quote in {{ $cityName }}?", 
                "acceptedAnswer": { 
                    "@@type": "Answer", 
                    "text": "Use the free Moving Cost Calculator on this page to get an instant estimate based on your move details." 
                } 
            }
        @endif
    ]
...
@section('custom_styles')
    ...
    <style>
        /* Unique directory elements styled specifically for City Movers */
        .m-row {
            background: #fafbfd; 
        ...
        .m-row:hover { 
            border-color: #d0dae8; 
            box-shadow: 0 6px 18px rgba(15,43,76,0.04); 
            background: white; 
        }
        .m-logo {
            width: 50px; 
        ...
        /* Dynamic Stats Strip mapping for all city pages */
        [class$="-highlight-strip"] {
        ...
        [class$="-highlight-strip"] > div {
            text-align: center;
            padding: 8px 12px;
            border-right: 1px solid rgba(255, 255, 255, 0.15);
        }
        [class$="-highlight-strip"] > div:last-child {
            border-right: none;
        }
        [class$="-highlight-strip"] span:first-child,
        [class$="-highlight-strip"] [class$="-val"] {
        ...
        [class$="-highlight-strip"] span:last-child,
        [class$="-highlight-strip"] [class$="-lbl"] {
        ...
        /* Dynamic Data Table mapping for all city pages */
        [class$="-data-table"] {
            width: 100%;
        ...
        [class$="-data-table"] tr:last-child td {
            border-bottom: none;
        }
        [class$="-data-table"] tr:nth-child(even) td {
            background-color: #f8fafc;
        }

        /* Dynamic Bullet Box mapping for all city pages */
        [class$="-bullet-box"] {
            background: #f8fafc;
            border: 1px solid var(--rich-border);
            border-radius: 16px;
        ...
        [class$="-bullet-box"] li:last-child {
            margin-bottom: 0;
        }
        [class$="-bullet-box"] li strong {
            color: var(--primary);
        }

        /* Dynamic CTA Box & Buttons mapping for all city pages */
        [class$="-cta-box"] {
        ...
        [class$="-cta-box"] p strong {
            color: var(--primary);
        }
        [class$="-cta-box"] a[class^="btn-"],
        [class$="-cta-box"] a.btn-aurora,
        [class$="-cta-box"] a.btn-chicago,
        [class$="-cta-box"] a.btn-nyc,
        [class$="-cta-box"] a.btn-miami,
        [class$="-cta-box"] a.btn-tampa,
        [class$="-cta-box"] a.btn-orlando,
        [class$="-cta-box"] a.btn-jacksonville,
        [class$="-cta-box"] a.btn-atlanta,
        [class$="-cta-box"] a.btn-augusta,
        [class$="-cta-box"] a.btn-columbus,
        [class$="-cta-box"] a.btn-savannah {
        ...
        [class$="-cta-box"] a[class^="btn-"]:hover,
        [class$="-cta-box"] a.btn-aurora:hover,
        [class$="-cta-box"] a.btn-chicago:hover,
        [class$="-cta-box"] a.btn-nyc:hover,
        [class$="-cta-box"] a.btn-miami:hover,
        [class$="-cta-box"] a.btn-tampa:hover,
        [class$="-cta-box"] a.btn-orlando:hover,
        [class$="-cta-box"] a.btn-jacksonville:hover,
        [class$="-cta-box"] a.btn-atlanta:hover,
        [class$="-cta-box"] a.btn-augusta:hover,
        [class$="-cta-box"] a.btn-columbus:hover,
        [class$="-cta-box"] a.btn-savannah:hover {
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6">
                <nav class="breadcrumb-nav">
                    ...
                    <i class="fas fa-chevron-right sep"></i>
                    <a href="{{ route('front.state.movers', $stateModel->slug ?: \Illuminate\Support\Str::slug($stateModel->name)) }}">{{ $stateName }}</a>
                    <i class="fas fa-chevron-right sep"></i>
                    <span class="current">{{ $cityName }}</span>
                </nav>

                @php
                    $h1Heading = $cityModel->content->heading ?? 'Best Movers in ' . $cityName;
                    $stateCode = $stateModel->code;
                    if (str_contains($h1Heading, $cityName)) {
                        if (!str_contains($h1Heading, $cityName . ', ' . $stateCode) && !str_contains($h1Heading, $cityName . ' ' . $stateCode)) {
                            $h1Heading = str_replace($cityName, $cityName . ', ' . $stateCode, $h1Heading);
                        }
                    } else {
                        $h1Heading = $h1Heading . ', ' . $stateCode;
                    }
                @endphp
                <h1 class="display-5 fw-900 mb-3">{{ $h1Heading }}</h1>
                <p class="hero-desc mb-0">
                    Compare licensed movers, read verified reviews, and get an instant moving estimate for your {{ $cityName }}, {{ $stateModel->code }} relocation.
                </p>
                ...
                <div class="hero-trust">
                    ...
                    <div class="trust-pill"><i class="fas fa-truck-fast"></i> {{ $companies->total() > 0 ? $companies->total() : rand(8,20) }}+ Movers</div>
                </div>
            </div>
...
<div class="container py-5">
    <div class="row g-5">
        ...
        <div class="col-lg-10 mx-auto">
            ...
            {{-- City Services --}}
            <section class="mb-5">
                <span class="section-badge"><i class="fas fa-truck-moving"></i> Local & Long Distance</span>
                <h2 class="fw-800 text-primary mb-3" style="font-size: 1.4rem;">Moving Services in {{ $cityName }}, {{ $stateModel->code }}</h2>
                <p class="text-muted mb-4" style="line-height: 1.85; font-size: 0.92rem;">Whether you're relocating across town or moving cross-country, <strong>Move Smooth</strong> connects you with vetted, FMCSA-verified moving professionals serving {{ $cityName }} and surrounding areas.</p>
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="svc-card">
                            ...
                            <p class="small text-muted mb-0" style="line-height: 1.7;">Hourly-rate local relocations within {{ $cityName }}. Professional loading, furniture padding, and same-day delivery.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="svc-card">
                            ...
                            <p class="small text-muted mb-0" style="line-height: 1.7;">Licensed interstate carriers with GPS tracking, binding estimates, and guaranteed delivery windows.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="svc-card">
                            <div class="svc-icon"><i class="fas fa-building"></i></div>
                            <h5 class="fw-bold text-primary mb-2" style="font-size: 0.95rem;">Commercial Moving</h5>
                            <p class="small text-muted mb-0" style="line-height: 1.7;">Office relocations, server rooms, cubicle systems. Zero-downtime weekend and after-hours scheduling.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="svc-card">
                            <div class="svc-icon"><i class="fas fa-boxes-packing"></i></div>
                            <h5 class="fw-bold text-primary mb-2" style="font-size: 0.95rem;">Packing & Storage</h5>
                            <p class="small text-muted mb-0" style="line-height: 1.7;">Full-service professional packing with climate-controlled secure storage vaults.</p>
                        </div>
                    </div>
                </div>
            </section>

            {{-- Why Choose Move Smooth --}}
            <section class="mb-5 pt-4 border-top">
                <span class="section-badge"><i class="fas fa-award"></i> Why Move Smooth</span>
                <h3 class="fw-800 text-primary mb-4" style="font-size: 1.3rem;">Why Choose Move Smooth in {{ $cityName }}?</h3>
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="why-card">
                            <div class="why-icon"><i class="fas fa-shield-halved"></i></div>
                            <h4 class="fw-bold text-primary mb-2">FMCSA Verified</h4>
                            <p class="small text-muted mb-0">Every mover holds active USDOT registration with verified insurance and safety records.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="why-card">
                            <div class="why-icon"><i class="fas fa-file-invoice-dollar"></i></div>
                            <h4 class="fw-bold text-primary mb-2">No Hidden Fees</h4>
                            <p class="small text-muted mb-0">Binding written estimates upfront. The price you see is the price you pay — guaranteed.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="why-card">
                            <div class="why-icon"><i class="fas fa-users-gear"></i></div>
                            <h4 class="fw-bold text-primary mb-2">Vetted Crews</h4>
                            <p class="small text-muted mb-0">Background-checked, drug-tested professionals with years of moving experience.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="why-card">
                            <div class="why-icon"><i class="fas fa-boxes-packing"></i></div>
                            <h4 class="fw-bold text-primary mb-2">Full Packing</h4>
                            <p class="small text-muted mb-0">Double-walled boxes, custom crating, bubble wrap — complete packing solutions available.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="why-card">
                            <div class="why-icon"><i class="fas fa-warehouse"></i></div>
                            <h4 class="fw-bold text-primary mb-2">Secure Storage</h4>
                            <p class="small text-muted mb-0">Climate-controlled warehouse vaults with 24/7 surveillance for short and long-term needs.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="why-card">
                            <div class="why-icon"><i class="fas fa-headset"></i></div>
                            <h4 class="fw-bold text-primary mb-2">Dedicated Support</h4>
                            <p class="small text-muted mb-0">Personal move coordinator assigned to your relocation from start to finish.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="mb-5 pt-4 border-top">
                <div class="interlink-box">
                    ...
                    <p class="text-muted mb-0" style="line-height: 1.9; font-size: 0.9rem;">
                        Need <a href="{{ route('front.service.local') }}">Local Moving</a>? 
                        Planning a cross-country move? See <a href="{{ route('front.service.long') }}">Long Distance</a>. 
                        We also offer <a href="{{ route('front.service.residential') }}">Residential</a>, 
            ...
            @if($cityModel->content && $cityModel->content->content)
            <section class="mb-5 pt-4 border-top">
                <span class="section-badge"><i class="fas fa-book-open"></i> {{ $cityName }} Moving Guide</span>
                <div class="state-rich-content text-muted mt-3" style="line-height: 1.9; font-size: 0.9rem;">
                    {!! $cityModel->content->content !!}
                </div>
            </section>
            @endif
            ...
            <section class="mb-5 pt-4 border-top">
                ...
                <h3 class="fw-800 text-primary mb-4" style="font-size: 1.3rem;">Top-Rated Moving Companies in {{ $cityName }}</h3>
            ...
            <section class="mb-5 pt-4 border-top">
                ...
                <h3 class="fw-800 text-primary mb-5" style="font-size: 1.3rem;">Top 3 Best Moving Companies in {{ $cityName }}</h3>
            ...
            <section class="mb-5 pt-4 border-top">
                ...
                <h3 class="fw-800 text-primary mb-4" style="font-size: 1.3rem;">In-Depth Reviews of the Best Movers in {{ $cityName }}</h3>
                ...
                @php
                    ...
                    $pros = ['Fully licensed, insured & USDOT/FMCSA registered', 'Zero hidden fees with clear hourly & weight estimates', 'Background-checked, drug-tested highly trained crews'];
                    $cons = ['Rates can be elevated during peak summer weekends', 'Requires 3-5 weeks advance reservation during peak season'];
                    
                    $cityLabel = $company->city ?? $cityName;
                @endphp
            ...
            {{-- Top Movers paginated list --}}
            <section class="mb-5 pt-4 border-top">
                <span class="section-badge"><i class="fas fa-star"></i> Top Movers</span>
                <h3 class="fw-800 text-primary mb-3" style="font-size:1.3rem">Best Moving Companies in {{ $cityName }}, {{ $stateModel->code }}</h3>
                <div class="row">
                    ...
                    <div class="col-12 text-center py-5 bg-white rounded-4 shadow-sm border">
                        ...
                        <p class="text-muted mb-0">No moving companies available in the directory for this city/state at this time.</p>
                    </div>
                    @endforelse
                </div>
                @if($companies->hasPages())<div class="mt-4 d-flex justify-content-center">{{ $companies->links() }}</div>@endif
            </section>

            {{-- ====================== DYNAMIC CONTENT BELOW ====================== --}}
            @if($cityModel->content && $cityModel->content->content_below)
            <section class="mb-5 pt-4 border-top">
                <span class="section-badge"><i class="fas fa-book-open"></i> {{ $cityName }} Detailed Guide</span>
                <div class="state-rich-content text-muted mt-3" style="line-height:1.9;font-size:0.88rem">
                    {!! $cityModel->content->content_below !!}
                </div>
            </section>
            @endif
            ...
            {{-- Reviews --}}
            <section class="mb-5 pt-4 border-top">
                <span class="section-badge"><i class="fas fa-quote-left"></i> Reviews</span>
                <h3 class="fw-800 text-primary mb-4" style="font-size:1.3rem">Customer Reviews in {{ $cityName }}</h3>
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="rv-card">
                            <div class="text-warning mb-2" style="font-size:0.8rem"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
                            <p class="small text-muted mb-3" style="line-height:1.75">"Moving my 3-bedroom home in {{ $cityName }} was seamless. The crew arrived early, wrapped all furniture with blankets, and handled everything carefully. Highly recommend!"</p>
                            <div class="d-flex align-items-center gap-2"><div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center" style="width:30px;height:30px;font-size:0.65rem;font-weight:800">JM</div><div><span class="fw-bold small text-primary">Jessica M.</span><span class="text-muted d-block" style="font-size:0.65rem">Verified Client</span></div></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="rv-card">
                            <div class="text-warning mb-2" style="font-size:0.8rem"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
                            <p class="small text-muted mb-3" style="line-height:1.75">"We used Move Smooth for our office relocation in {{ $cityName }}. Zero downtime, professional packing of all IT equipment, and everything was set up by Monday morning."</p>
                            <div class="d-flex align-items-center gap-2"><div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center" style="width:30px;height:30px;font-size:0.65rem;font-weight:800">RT</div><div><span class="fw-bold small text-primary">Robert T.</span><span class="text-muted d-block" style="font-size:0.65rem">Business Owner</span></div></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="mb-5 pt-4 border-top">
                ...
                <h3 class="fw-800 text-primary mb-4" style="font-size:1.3rem">Frequently Asked Questions About Moving in {{ $cityName }}</h3>
                <div class="accordion state-faq" id="cityFaq">
                    @if(\Illuminate\Support\Facades\Schema::hasTable('city_faqs') && $cityModel->faqs->count() > 0)
                        @foreach($cityModel->faqs as $index => $faq)
                        <div class="accordion-item border-0 mb-3">
                            <h4 class="accordion-header">
                                <button class="accordion-button rounded-3 {{ $index !== 0 ? 'collapsed' : '' }}" type="button" data-bs-toggle="collapse" data-bs-target="#cfaq-dyn-{{ $faq->id }}" aria-expanded="{{ $index === 0 ? 'true' : 'false' }}">
                                    {{ $faq->question }}
                                </button>
                            </h4>
                            <div id="cfaq-dyn-{{ $faq->id }}" class="accordion-collapse collapse {{ $index === 0 ? 'show' : '' }}" data-bs-parent="#cityFaq">
                        ...
                        @endforeach
                    @else
                        <div class="accordion-item border-0 mb-3"><h4 class="accordion-header"><button class="accordion-button rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#cf1">How much do movers cost in {{ $cityName }}?</button></h4><div id="cf1" class="accordion-collapse collapse show" data-bs-parent="#cityFaq"><div class="accordion-body">Local moves in {{ $cityName }} typically cost between <strong>$400 and $1,500</strong> depending on home size and crew hours. Long-distance relocations range from <strong>$2,500 to $6,000+</strong> based on shipment weight and mileage. Use our calculator above for a personalized estimate.</div></div></div>
                        <div class="accordion-item border-0 mb-3"><h4 class="accordion-header"><button class="accordion-button collapsed rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#cf2">Are {{ $cityName }} movers licensed and insured?</button></h4><div id="cf2" class="accordion-collapse collapse" data-bs-parent="#cityFaq"><div class="accordion-body">Yes. Every mover on Move Smooth holds an active USDOT number and is registered with the Federal Motor Carrier Safety Administration (FMCSA). We verify operating authority, cargo insurance, and complaint history before listing any company.</div></div></div>
                        <div class="accordion-item border-0 mb-3"><h4 class="accordion-header"><button class="accordion-button collapsed rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#cf3">How far in advance should I book movers in {{ $cityName }}?</button></h4><div id="cf3" class="accordion-collapse collapse" data-bs-parent="#cityFaq"><div class="accordion-body">We recommend booking <strong>2–4 weeks in advance</strong> for local moves and <strong>4–8 weeks</strong> for long-distance moves. During peak season (May–September), book even earlier to secure your preferred dates and rates.</div></div></div>
                        <div class="accordion-item border-0 mb-3"><h4 class="accordion-header"><button class="accordion-button collapsed rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#cf4">What is the cheapest day to move in {{ $cityName }}?</button></h4><div id="cf4" class="accordion-collapse collapse" data-bs-parent="#cityFaq"><div class="accordion-body">Mid-week days (<strong>Tuesday through Thursday</strong>) and mid-month dates typically offer 15–25% lower rates. Winter months (October–February) are also significantly cheaper than peak summer season.</div></div></div>
                        <div class="accordion-item border-0 mb-3"><h4 class="accordion-header"><button class="accordion-button collapsed rounded-3" type="button" data-bs-toggle="collapse" data-bs-target="#cf5">Do movers in {{ $cityName }} offer packing services?</button></h4><div id="cf5" class="accordion-collapse collapse" data-bs-parent="#cityFaq"><div class="accordion-body">Yes. Most of our {{ $cityName }} movers offer partial and full packing services including professional wrapping, double-walled boxes, custom crating for artwork, and complete unpacking at your destination.</div></div></div>
                    @endif
                </div>
            </section>
...
<section class="state-bottom-cta text-center">
    <div class="container position-relative" style="z-index:2">
        <h2 class="fw-800 mb-3 display-6">Ready to Move in {{ $cityName }}?</h2>
        ...
        <div class="d-flex flex-wrap justify-content-center gap-3">
            ...
            <a href="{{ route('front.state.movers', $stateModel->slug ?: \Illuminate\Support\Str::slug($stateModel->name)) }}" class="btn btn-outline-dark btn-lg px-5 py-3 fw-800 rounded-pill">Browse {{ $stateName }} Movers</a>
        </div>
    </div>
</section>
@endsection
...
(function() {
    // ============================================================
    // Unified Multi-Step Calculator — Full Logic
    // ============================================================
    let currentStep = 1;
