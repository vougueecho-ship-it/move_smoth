            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content" class="form-control tinymce" rows="15" placeholder="Write your post content here..."></textarea>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="bg-light p-4 rounded-3 border">
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary w-100 py-2">Save Blog Post</button>
